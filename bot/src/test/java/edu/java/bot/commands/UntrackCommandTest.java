...
//
//    @Autowired
//    UntrackCommandTest(CommandsService commandsService, LinkService linkService, UserService userService) {
...
//        SendMessage linkResponse = linkService.deleteLink(update.message().chat().id(), link);
